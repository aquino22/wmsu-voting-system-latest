                                            ...
                                            <div class="card px-5 pt-5">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <?php
                                                        try {
                                                            // Fetch all moderators and their precinct status
                                                            $sql = "SELECT m.id, m.name, m.email, m.password, m.gender, m.department, m.precinct as precinct_real,
       m.status, m.college, p.name AS precinct_name, p.assignment_status 
FROM moderators m 
LEFT JOIN precincts p ON m.precinct = p.id; -- Ensure precinct is stored as an ID
"; // Join with precincts table
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($moderators as $moderator): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php
                                                                            if (!empty($moderator['precinct_real'])) {
                                                                                $decoded = json_decode($moderator['precinct_real'], true);
                                                                                ...
                                                                                if (is_array($decoded) && count($decoded) > 0) {
                                                                                    ...
                                                                                    echo htmlspecialchars($moderator['precinct_real']);
                                                                                }
                                                                            } else {
                                                                                echo 'None';
                                                                            }
                                                                        ...
                                                                        <td>
                                                                            <button type="button" class="btn btn-success view-moderator-btn text-white" data-bs-toggle="modal"
                                                                                ...
                                                                                data-precinct="<?= htmlspecialchars($moderator['precinct_real']); ?>"
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="form-check mb-2 ">
                                                                <input class="form-check-input" type="checkbox" id="selectAllPrecincts" style="margin-left: 0px;">
                                                                <label class="form-check-label fw-bold" style="padding-left: 3px !important"> &nbsp; Select All</label>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="form-check mb-2">
                                                                <input class="form-check-input" type="checkbox" id="editSelectAllPrecincts">
                                                                <label class="form-check-label fw-bold" for="editSelectAllPrecincts">Select All</label>
                                                            </div>
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    function addSelectAllFunctionality() {
                                        const checkboxes = document.querySelectorAll(".precinct-check");

                                        selectAllPrecincts.addEventListener("change", function() {
                                            checkboxes.forEach(cb => cb.checked = this.checked);
                                        });

                                        // Auto-update Select All when manually checking items
                                        checkboxes.forEach(cb => {
                                            cb.addEventListener("change", function() {
                                                const total = checkboxes.length;
                                                const checked = document.querySelectorAll(".precinct-check:checked").length;
                                                selectAllPrecincts.checked = total === checked;
                                            });
                                        });
                                    }
                                    ...
                                    const selectAllPrecincts = document.getElementById('selectAllPrecincts');
                                    ...
                                    function loadPrecincts() {
                                        ...
                                        selectAllPrecincts.checked = false;
...
`;
                            ...
                            <script>
                                ...
                                function togglePasswordEdit() {
                                    const passwordField = document.getElementById('edit_password');
                                    const toggleIcon = document.getElementById('toggleIcon_edit');
                                ...
                                function checkPasswordStrengthEdit() {
                                    ...
                                    const strengthBar = document.getElementById('strength-bar_edit');
                                    const strengthText = document.getElementById('strength-text_edit');
                                    let strength = 0;
                                    ...
                                    strengthBar.style.display = 'block';
                                    strengthBar.children[0].style.width = strength + '%';
                                    if (strength <= 25) {
                                        strengthText.innerText = 'Weak';
                                        strengthBar.children[0].className = 'progress-bar bg-danger';
                                    } else if (strength <= 50) {
                                        strengthText.innerText = 'Fair';
                                        strengthBar.children[0].className = 'progress-bar bg-warning';
                                    } else if (strength <= 75) {
                                        strengthText.innerText = 'Good';
                                        strengthBar.children[0].className = 'progress-bar bg-info';
                                    } else {
                                        strengthText.innerText = 'Strong';
                                        strengthBar.children[0].className = 'progress-bar bg-success';
                                    }
                                }
                            </script>
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    const precinctContainer = document.getElementById('edit_precinct_container');
                                    const selectAllCheckbox = document.getElementById('editSelectAllPrecincts');

                                    let currentPrecincts = []; // To pre-check the moderator's assigned precincts

                                    // Call this when you open the edit modal
                                    function setCurrentPrecincts(moderatorData) {
                                        try {
                                            const parsed = JSON.parse(moderatorData.precinct_real);
                                            currentPrecincts = Array.isArray(parsed) ? parsed : [moderatorData.precinct_real];
                                        } catch {
                                            currentPrecincts = moderatorData.precinct_real ? [moderatorData.precinct_real] : [];
                                        }

                                        document.getElementById('current_precinct').textContent = currentPrecincts.join(', ');
                                    }

                                    // Load precincts dynamically based on college + department
                                    function loadPrecinctsSelected() {
                                        const college = collegeSelect.value;
                                        const department = departmentSelect.value;
                                                ...
                                                .then(data => {
                                                    ...
                                                    if (data.success && data.precincts.length > 0) {
                                                        data.precincts.forEach(p => {
                                                            const cap = p.current_capacity;
                                                            let color = 'text-success';
                                                            if (cap >= 30 && cap < 70) color = 'text-warning';
                                                            if (cap >= 70) color = 'text-danger fw-bold';

                                                            const div = document.createElement('div');
                                                            div.classList.add('form-check', 'mb-1');

                                                            div.innerHTML = `
                                <input class="form-check-input edit-precinct-check" type="checkbox" name="precincts[]" value="${p.name}" id="edit_precinct_${p.name}">
                                <label class="form-check-label" for="edit_precinct_${p.name}">
                                    <span class="${color}">${p.name} (${p.location}) – ${cap} people</span>
                                </label>
                            `;

                                                            precinctContainer.appendChild(div);

                                                            // Pre-check if this precinct belongs to the moderator
                                                            if (currentPrecincts.includes(p.name)) {
                                    ...
                                    function addSelectAllFunctionality() {
                                        const checkboxes = document.querySelectorAll('.edit-precinct-check');
                                        ...
                                        checkboxes.forEach(cb => {
                                            cb.addEventListener('change', function() {
                                                const total = checkboxes.length;
                                                const checked = document.querySelectorAll('.edit-precinct-check:checked').length;
                                                selectAllCheckbox.checked = total === checked;
                                            });
                                        });
                                    }

                                    // Load precincts when college or department changes
                                    collegeSelect.addEventListener('change', loadPrecinctsSelected);
                                    departmentSelect.addEventListener('change', loadPrecinctsSelected);

                                    // Expose function to set moderator data when opening modal
                                    window.showEditModal = function(moderatorData) {
                                        setCurrentPrecincts(moderatorData);

                                        collegeSelect.value = moderatorData.college;
                                        departmentSelect.value = moderatorData.department;

                                        loadPrecinctsSelected();
                                    }
                                });
                                ...
                                document.getElementById('editModeratorForm').addEventListener('submit', function(e) {
                                    ...
                                    // Create FormData and override the password value
                                    const formData = new FormData(this);
                                    formData.set('password', password); // Replace original password with hashed
                                    ...
                                    fetch('update_moderator.php', {
                                        ...
                                        .catch(error => {
                                            ...
                                            Swal.fire({
                                                icon: 'error',
                                                title: 'Error!',
                                                text: 'An error occurred while updating the moderator.',
                                                timer: 2000,
                                                showConfirmButton: false
                                            });
                                        });
