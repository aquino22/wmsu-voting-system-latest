...
<head>
  <title>WMSU i-Elect Admin: Editing Precinct</title>
  <!-- Bootstrap CSS -->
...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $stmt = $pdo->prepare("SELECT * FROM precincts WHERE id = ?");
  $stmt->execute([$id]);
    ...
    <div class="card 3">
      <div class="card-body">
        <h2 class="card-title mb-4 text-primary text-center">
          <i class="mdi mdi-map-marker"></i> Editing Existing Precinct for Elections
        </h2>
        <form id="addPrecinctForm" action="processes/precincts/edit.php">
            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name"
                  ...
                  placeholder="Enter precinct name" required>
              </div>
              <div class="mb-3">
                <label for="location" class="form-label">Location: </label>
                <input type="text" class="form-control form-control-sm"
                  value="<?= htmlspecialchars($precinctData['location'] ?? '') ?>"
                  placeholder="Enter location or name here: e.g. (WMSU Social Hall)" name="location" id="precinctLocation" required>
              </div>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="campus_type" name="type" required>
                  ...
                  <option value="Main Campus"
                    <?= ($precinctData['type'] ?? '') === 'Main Campus' ? 'selected' : '' ?>>Main Campus</option>
                  <option value="ESU Campus"
                    <?= ($precinctData['type'] ?? '') === 'External' ? 'selected' : '' ?>>WMSU ESU</option>
                </select>
              </div>
              ...
              <div class="mb-3" id="campus-location-container" style="display: none;">
                ...
                <?php
                $storedLocation = trim($precinctData['college_external'] ?? '');
                $locations = [
                  'WMSU Curuan',
                  'WMSU Imelda',
                  'WMSU Siay',
                ...
                ?>
                (<?php echo $storedLocation ?>)
                <select class="form-select" id="college_external" name="college_external" required>
                  <option value="" disabled <?= $storedLocation === '' ? 'selected' : '' ?>>Select College Location</option>
                  <?php foreach ($locations as $loc): ?>
                    <option value="<?= htmlspecialchars($loc) ?>" <?= $storedLocation === $loc ? 'selected' : '' ?>>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="college_type" name="college" required>
                  <option value="" disabled <?= empty($precinctData['college']) ? 'selected' : '' ?>>Select College Type</option>
                  <option value="College of Law" <?= ($precinctData['college'] ?? '') === 'College of Law' ? 'selected' : '' ?>>College of Law</option>
                  <option value="College of Agriculture" <?= ($precinctData['college'] ?? '') === 'College of Agriculture' ? 'selected' : '' ?>>College of Agriculture</option>
                  <option value="College of Liberal Arts" <?= ($precinctData['college'] ?? '') === 'College of Liberal Arts' ? 'selected' : '' ?>>College of Liberal Arts</option>
                  <option value="College of Architecture" <?= ($precinctData['college'] ?? '') === 'College of Architecture' ? 'selected' : '' ?>>College of Architecture</option>
                  <option value="College of Nursing" <?= ($precinctData['college'] ?? '') === 'College of Nursing' ? 'selected' : '' ?>>College of Nursing</option>
                  <option value="College of Asian & Islamic Studies" <?= ($precinctData['college'] ?? '') === 'College of Asian & Islamic Studies' ? 'selected' : '' ?>>College of Asian & Islamic Studies</option>
                  <option value="College of Computing Studies" <?= ($precinctData['college'] ?? '') === 'College of Computing Studies' ? 'selected' : '' ?>>College of Computing Studies</option>
                  <option value="College of Forestry & Environmental Studies" <?= ($precinctData['college'] ?? '') === 'College of Forestry & Environmental Studies' ? 'selected' : '' ?>>College of Forestry & Environmental Studies</option>
                  <option value="College of Criminal Justice Education" <?= ($precinctData['college'] ?? '') === 'College of Criminal Justice Education' ? 'selected' : '' ?>>College of Criminal Justice Education</option>
                  <option value="College of Home Economics" <?= ($precinctData['college'] ?? '') === 'College of Home Economics' ? 'selected' : '' ?>>College of Home Economics</option>
                  <option value="College of Engineering" <?= ($precinctData['college'] ?? '') === 'College of Engineering' ? 'selected' : '' ?>>College of Engineering</option>
                  <option value="College of Medicine" <?= ($precinctData['college'] ?? '') === 'College of Medicine' ? 'selected' : '' ?>>College of Medicine</option>
                  <option value="College of Public Administration & Development Studies" <?= ($precinctData['college'] ?? '') === 'College of Public Administration & Development Studies' ? 'selected' : '' ?>>College of Public Administration & Development Studies</option>
                  <option value="College of Sports Science & Physical Education" <?= ($precinctData['college'] ?? '') === 'College of Sports Science & Physical Education' ? 'selected' : '' ?>>College of Sports Science & Physical Education</option>
                  <option value="College of Science and Mathematics" <?= ($precinctData['college'] ?? '') === 'College of Science and Mathematics' ? 'selected' : '' ?>>College of Science and Mathematics</option>
                  <option value="College of Social Work & Community Development" <?= ($precinctData['college'] ?? '') === 'College of Social Work & Community Development' ? 'selected' : '' ?>>College of Social Work & Community Development</option>
                  <option value="College of Teacher Education" <?= ($precinctData['college'] ?? '') === 'College of Teacher Education' ? 'selected' : '' ?>>College of Teacher Education</option>
              ...
              <div class="mb-3">
                <label for="department" class="form-label">
                  <i class="mdi mdi-domain me-1"></i>Department (<?php echo $precinctData['department'] ?>)
                </label>
              ...
              <div class="mb-3">
                <label class="form-label">
                  <i class="mdi mdi-vote-outline me-1"></i>Select One Election Below:
                </label>
