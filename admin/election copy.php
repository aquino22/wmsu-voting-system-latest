                  ...
                  <div class="card card-rounded mb-5">
                    <div class="card-body">
                      <div class="row mt-4">
                        ...
                        try {
                          $stmtFilter = $pdo->prepare("SELECT DISTINCT election_name FROM elections WHERE status IN ('Scheduled', 'Ongoing', 'Upcoming', 'TBD', 'Published') ORDER BY election_name");
                          $stmtFilter->execute();
                            ...
                            render: function(data, type, row) {
                              ...
                              try {
                                ...
                                if (!colleges || !colleges.length) {
                                  return '<span class="badge bg-secondary">Any College</span>';
                                }
                    ...
                    function filterPartyTable() {
                      ...
                      if (status) {
                        partyStatusCustomFilter = function(settings, data, dataIndex) {
                          ...
                          var rowStatus = (rowData.status || '').toString().trim().toLowerCase();
