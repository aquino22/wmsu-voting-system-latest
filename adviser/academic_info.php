                            ...
                            <div class="home-tab">
                                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Academic Year Information</a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-5">
                                                <div class="d-flex align-items-center mb-5">
                                                    <h3><b>Academic Year Information</b></h3>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <input type="number" class="form-control" id="endYear" name="end_year" placeholder="YYYY" readonly>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <!-- Custom Voter Option -->
                                                                    <div class="mb-3 form-check" style="margin-left: 25px;">
                                                                        <input type="checkbox" class="form-check-input" id="customVoterOption" name="custom_voter_option" value="1">
                                                                        <label class="form-check-label" for="customVoterOption">Enable Custom Voter Option</label>
                                                                    </div>
                                                        ...
                                                        <?php if (!empty($academic_years)): ?>
                                                            <?php foreach ($academic_years as $ay): ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= htmlspecialchars(date('F j, Y', strtotime($ay['start_date']))) ?></td>
                                                                    <td><?= htmlspecialchars(date('F j, Y', strtotime($ay['end_date']))) ?></td>
                                                                    <td>
                                                                        <?= isset($ay['custom_voter_option']) && $ay['custom_voter_option'] == 1 ? '<span class="badge bg-info">Enabled</span>' : '<span class="badge bg-dark">Disabled</span>' ?>
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        foreach ($elections as $election):
                                                                            ...
                                                                            if ($isArchived) {
                                                                                ...
                                                                                // ✅ Use precomputed archived summary
                                                                                $stmtSummary = $pdo->prepare("
    SELECT candidates, precincts, voters
    FROM archived_details_short
    WHERE election_id = ?
    LIMIT 1
");
                                                                                $stmtSummary->execute([$election['id']]);
                                                                                $summary = $stmtSummary->fetch(PDO::FETCH_ASSOC);

                                                                                if ($summary) {
                                                                                    echo "<ul class='voting-period-list'>";
                                                                                    echo "<li>";
                                                                                    echo "<em>Archived Summary:</em><br>";
                                                                                    echo "&nbsp;&nbsp;• Candidates: " . (int)$summary['candidates'] . "<br>";
                                                                                    echo "&nbsp;&nbsp;• Precincts: " . (int)$summary['precincts'] . "<br>";
                                                                                    echo "&nbsp;&nbsp;• Voters: " . (int)$summary['voters'] . "<br>";
                                                                                    echo "</li>";
                                                                                    echo "</ul>";
                                                                                } else {
                                                                                    echo "<em>No archived summary found.</em>";
                                                                                }
                                                                            } else {
