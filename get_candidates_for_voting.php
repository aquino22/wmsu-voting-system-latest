...
$electionName = $election['election_name'];
    ...
    foreach ($candidateIds as $candidateId) {
        ...
        // Get college/department from voters table
        $stmt = $pdo->prepare("
            SELECT college, department 
            FROM voters 
            WHERE CONCAT(TRIM(first_name), ' ', 
        ...
        if ($voterData) {
            $candidate['college'] = $voterData['college'] ?? 'N/A';
            $candidate['department'] = $voterData['department'] ?? 'N/A';
        }
